...
export default async function TermsPage() {
  ...
  if (!status.data?.user_agreement_enabled) {
    notFound()
  }

  const response = await fetch(buildNewApiUrl('/api/user-agreement'), {
